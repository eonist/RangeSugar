...
extension CountableRange/* where Bound:Integer */{
    ...
    public var numOfIndecies: Int { return (self.end as! Int) - (self.start as! Int) + 1 }//TODO: rewrite this as: length + 1
    public var random: Int {
      let max = self.end as! Int
      let min = self.start as! Int
      let random = Int(arc4random_uniform(UInt32(max)) + UInt32(min))
      return random
   }
}
extension Range {
