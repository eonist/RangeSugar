...
class RangeParser {
     ...
     */
    public static func max<T>(_ range: Range<T>) -> T {
     ...
     */
    public static func difference(_ range: Range<Int>) -> Int {
     ...
     */
    public static func numOfIndecies(_ range: Range<Int>) -> Int {
     ...
     */
    public static func intersection<T>(_ a: Range<T>, _ b: Range<T>) -> Range<T>? {
        var start: T?
     ...
     */
    public static func exclusion<T>(_ a: Range<T>, _ b: Range<T>) -> (Range<T>?, Range<T>?) {
     ...
     */
    public static func difference<T>(_ a: Range<T>, _ b: Range<T>) -> (Range<T>?, Range<T>?) {
